...
import com.example.absolutelysaurabh.petcare.data.PetDbHelper;
...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Find and set the empty view on the LIstView , so that
        //it only showa when the list has zero items
        View emptyView = findViewById(R.id.empty_view);
        petListView.setEmptyView(emptyView);

        //Setup the adapter again to create a list item for each
        //row of the pet data in the Cursor.
        ...
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //need id to identify which item we have clicked on
                Intent intent = new Intent(CatalogActivity.this, EditorActivity.class);

                //Form the content URI that represents the specific pet that was clicked in,
                ...
                //Launch the linked EditorActivity to display the data for the current pet
                startActivity(intent);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        //This loader will execute the ContentProvider a
